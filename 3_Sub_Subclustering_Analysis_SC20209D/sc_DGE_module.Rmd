...
DGEinputList <- list(
  ...
  "comp_5" = list(
      "name"    = "DGE_Biotin_cLZ_vs_pLZ",
      "DGEselCol" = "cluster_sample",
      "DGEsampleList" = list(
          "BioCentralLZ"   = c("Central_LZ_Biotin24hFilt","Central_LZ_Biotin7dFilt"),
          "BioPeripheralLZ" = c("Peripheral_LZ_Biotin24hFilt", "Peripheral_LZ_Biotin7dFilt")
      )
  ),
  "comp_6" = list(
      "name"    = "DGE_Cxcl13_cLZ_vs_pLZ",
      "DGEselCol" = "cluster_sample",
      "DGEsampleList" = list(
          "Cxcl13CentralLZ"   = c("Central_LZ_CXCL13ICPE24hFilt"),
          "CxCl13PeripheralLZ" = c("Peripheral_LZ_CXCL13ICPE24hFilt")
      )
  ),
  "comp_7" = list(
      "name"    = "DGE_BioCentralLZ_vs_Cxcl13LZ",
      "DGEselCol" = "cluster_sample",
      "DGEsampleList" = list(
          "BioCentralLZ"   = c("Central_LZ_Biotin24hFilt","Central_LZ_Biotin7dFilt"),
          "Cxcl13CentralLZ" = c("Central_LZ_CXCL13ICPE24hFilt")
  ...
  "comp_8" = list(
      "name"    = "DGE_BioPeripheralLZ_vs_Cxcl13LZ",
      "DGEselCol" = "cluster_sample",
      "DGEsampleList" = list(
          "BioPeripheralLZ"   = c("Peripheral_LZ_Biotin24hFilt", "Peripheral_LZ_Biotin7dFilt"),
          "Cxcl13PeripheralLZ" =  c("Peripheral_LZ_CXCL13ICPE24hFilt")
